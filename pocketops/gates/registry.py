...
class Phase(str, Enum):
    """
    Workflow phases in PocketOps.

    The workflow progresses linearly through these phases,
    ...
    def register(
        ...
        Usage:
            @GateRegistry.register(
                ...
                description="Outcome contract must exist"
            )
            def check_contract_exists(run_context: dict) -> GateResult:
                ...
        """
